...
function shuffleArr(obj) {
  return obj.sort(()=> Math.random() - 0.5)
}

let pets = generateRandomPets()

function generateRandomPets(){
  let newPets = [];
  for(let i = 0;i < 6;i++){
    newPets.push(...shuffleArr(mainPets))
  }
  return newPets
}
// export const test =   `
//   <div class="card">
//   <div class="image"><img src="assets/images/pets/pets/pets-katrine.png" alt=""></div>
